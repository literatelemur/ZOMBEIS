...
//         std::vector<std::vector<double>> rect_points_3D_leg2;
        ...
        void Zombie::render_zombie(Graphics* graphics){
            ...
            std::vector<std::vector<std::vector<std::vector<int>>>> rect_triangle_points_2D_body = graphics->compute_2D_triangles(rect_triangle_points_3D_body);
            ...
            std::vector<std::vector<std::vector<std::vector<int>>>> rect_triangle_points_2D_arm1 = graphics->compute_2D_triangles(rect_triangle_points_3D_arm1);
            ...
            std::vector<std::vector<std::vector<std::vector<int>>>> rect_triangle_points_2D_arm2 = graphics->compute_2D_triangles(rect_triangle_points_3D_arm2);
            ...
            std::vector<std::vector<std::vector<std::vector<int>>>> rect_triangle_points_2D_leg1 = graphics->compute_2D_triangles(rect_triangle_points_3D_leg1);
            ...
            std::vector<std::vector<std::vector<std::vector<int>>>> rect_triangle_points_2D_leg2 = graphics->compute_2D_triangles(rect_triangle_points_3D_leg2);
