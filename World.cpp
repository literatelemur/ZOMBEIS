...
void World::render(Graphics* graphics){
    ...
    std::vector<std::vector<std::vector<std::vector<std::vector<double>>>>> ordered_sphere_triangle_points_3D = graphics->find_triangle_points_sphere(ordered_sphere_points_3D);
    ...
    graphics->draw_hollow_triangles_sphere_as_lines(clipped_ordered_sphere_triangle_points_2D_as_lines);


    // Drawing floor lines

    std::vector<std::vector<std::vector<std::vector<double>>>> ordered_floor_points_3D = graphics->find_floor_lines_on_globe(ordered_sphere_triangle_points_3D);

    std::vector<std::vector<std::vector<std::vector<double>>>> clipped_ordered_floor_points_3D = graphics->clip_sphere_lines(ordered_floor_points_3D);
